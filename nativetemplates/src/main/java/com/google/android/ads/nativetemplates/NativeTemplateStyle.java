...
public class NativeTemplateStyle {
  ...
  // Call to action z_background color.
  ...
  // Primary text z_background color.
  private ColorDrawable primaryTextBackgroundColor;

  // The typeface, typeface color, and z_background color for the second row of text in the template.
  ...
  // Secondary text z_background color.
  private ColorDrawable secondaryTextBackgroundColor;

  // The typeface, typeface color, and z_background color for the third row of text in the template.
  ...
  // Tertiary text z_background color.
  private ColorDrawable tertiaryTextBackgroundColor;

  // The z_background color for the bulk of the ad.
